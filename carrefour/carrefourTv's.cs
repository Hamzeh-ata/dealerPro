        ...
        public async Task getTv()
        {
         ...
         /*   chromeOptions.AddArgument("--headless");
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://www.carrefourjordan.com/mafjor/en/c/NFJOR4080400");
                Thread.Sleep(12000);
                ...
                while (flag)
                {
                    var TV = wait.Until(driver => driver.FindElements(By.CssSelector(".css-b9nx4o")));
                    var productsCount = TV.Count();
                    ...
                    try
                    {
                        ...
                        for (; i < productsCount; i++)
                        {
                                  ...
                                  js.ExecuteScript("arguments[0].scrollIntoView();", TV[i]);
                                   ...
                                   if (wait.Until(driver => TV[i].FindElements(By.CssSelector(".css-iqeby6"))).Count > 0)
                                   {
                                       orginalPriceBeforeClick = wait.Until(driver => TV[i].FindElement(By.CssSelector(".css-iqeby6 > .css-17fvam3"))).Text.Replace(",", ""); ;
                                       currentPrice = wait.Until(driver => TV[i].FindElement(By.CssSelector(".css-2a09gr > .css-17fvam3"))).Text.Replace(",", ""); ;
                                   }
                                   else
                                   {
                                       currentPrice = wait.Until(driver => TV[i].FindElement(By.CssSelector(".css-fzp91j > .css-17fvam3"))).Text.Replace(",", ""); ;
                                   ...
                                   string NameBeforeClick = TV[i].FindElement(By.CssSelector(".css-11qbfb > .css-1nhiovu > a")).Text;
                                ...
                                driver.ExecuteScript("window.open(arguments[0]);", TV[i].FindElement(By.CssSelector(".css-1nhiovu > a")).GetAttribute("href"));
                                       ...
                                       if (wait.Until(driver => driver.FindElements(By.CssSelector("section.css-168eikn > .css-1oh8fze > h2.css-1i90gmp > span.css-rmycza > del.css-1bdwabt"))).Count > 0)
                                       {
                                           ...
                                           oldPrice = wait.Until(driver => driver.FindElement(By.CssSelector("section.css-168eikn  > .css-1oh8fze > span.css-rmycza > del.css-1bdwabt"))).Text;
