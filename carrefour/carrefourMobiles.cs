    ...
    public class carrefourMobiles: Hub ,IcarrefourMobiles
    {
        ...
        public async Task getMobile()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://www.carrefourjordan.com/mafjor/en/c/NFJOR1220200");
                Thread.Sleep(12000);
                ...
                while (flag)
                {
                    var Mobile = wait.Until(driver => driver.FindElements(By.CssSelector(".css-b9nx4o")));
                    var productsCount = Mobile.Count();
                    ...
                    try
                    {
                        ...
                        for (; i < productsCount; i++)
                        {
                            ...
                            if (wait.Until(driver => Mobile[i].FindElements(By.CssSelector(".css-iqeby6"))).Count > 0)
                            {
                                orginalPriceBeforeClick = wait.Until(driver => Mobile[i].FindElement(By.CssSelector(".css-iqeby6 > .css-17fvam3"))).Text.Replace(",", ""); ;
                                currentPrice = wait.Until(driver => Mobile[i].FindElement(By.CssSelector(".css-2a09gr > .css-17fvam3"))).Text.Replace(",", ""); ;
                            }
                            else
                            {
                                currentPrice = wait.Until(driver => Mobile[i].FindElement(By.CssSelector(".css-fzp91j > .css-17fvam3"))).Text.Replace(",", ""); ;
                            ...
                            string NameBeforeClick = Mobile[i].FindElement(By.CssSelector(".css-11qbfb > .css-1nhiovu > a")).Text;
                            ...
                            else
                            {
                                ...
                                driver.ExecuteScript("window.open(arguments[0]);", Mobile[i].FindElement(By.CssSelector(".css-1nhiovu > a")).GetAttribute("href"));
