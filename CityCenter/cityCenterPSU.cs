    ...
    public class cityCenterPSU : Hub, IcityCenterPSU
    {
        ...
        public async Task GetPsu()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://citycenter.jo/gaming/gaming-power-supply");
                Thread.Sleep(10000);
                ...
                while (true)
                {
                    ...
                    {
                        Thread.Sleep(5000);
                        var PSU = wait.Until(driver => driver.FindElements(By.CssSelector(".product-layout > .product-thumb")));
                        for (int i = 0; i < PSU.Count(); i++) // loop through all CPUs except the last one
                        {
                            Thread.Sleep(5000);
                            ...
                            else
                            {
                                ...
                                PSU = driver.FindElements(By.CssSelector(".product-layout > .product-thumb"));
                            }
                        }
                    }
                    catch (NoSuchElementException ex)
