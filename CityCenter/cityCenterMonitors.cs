    ...
    public class cityCenterMonitors : Hub, IcityCenterMonitors
    {
        ...
        public async Task getMonitor()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://citycenter.jo/gaming/gaming-monitor/gaming-monitors");
                Thread.Sleep(10000);
                ...
                while (true)
                {
                    ...
                    {
                        Thread.Sleep(5000);
                        var monitor = wait.Until(driver => driver.FindElements(By.CssSelector(".product-layout > .product-thumb")));
                        for (int i = 0; i < monitor.Count(); i++)
                        {
                            ...
                            {
                                Console.WriteLine("The element and the price are already the same and exists" + i);
                            ...
                            else
                            {
                                ...
                                storedproducts.Add(monitorName.Text);
                                ...
                                monitor = driver.FindElements(By.CssSelector(".product-layout > .product-thumb"));
                            }
                        }
                    }
                    catch (NoSuchElementException ex)
