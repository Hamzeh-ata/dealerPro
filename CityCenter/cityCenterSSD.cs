    ...
    public class cityCenterSSD : Hub, IcityCenterSSD
    {
        ...
        public async Task GetSSD()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://citycenter.jo/gaming-storage-drive/ssds");
                Thread.Sleep(10000);
                ...
                while (true)
                {
                    ...
                    {
                        Thread.Sleep(5000);
                        var SSD = wait.Until(driver => driver.FindElements(By.CssSelector(".product-layout > .product-thumb")));
                        for (int i = 0; i < SSD.Count(); i++) 
                            // loop through all CPUs except the last one
                        {
                            Thread.Sleep(5000);
                            ...
                            else
                            {
                                ...
                                storedproducts.Add(SSDName.Text);
                                ...
                                SSD = driver.FindElements(By.CssSelector(".product-layout > .product-thumb"));
                            }
                        }
                    }
                    catch (NoSuchElementException ex)
