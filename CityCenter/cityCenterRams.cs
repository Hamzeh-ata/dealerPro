    ...
    public class cityCenterRams : Hub, IcityCenterRams
    {
        ...
        public async Task GetRAM()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://citycenter.jo/gaming/gaming-memory-ram");
                Thread.Sleep(10000);
                ...
                while (true)
                {
                    ...
                    {
                        Thread.Sleep(10000);
                        var RAM = driver.FindElements(By.CssSelector(".product-layout > .product-thumb"));
                        for (int i = 0; i < RAM.Count(); i++) // loop through all CPUs except the last one
                        {
                            Thread.Sleep(5000);
                            ...
                            else
                            {
                                ...
                                RAM = driver.FindElements(By.CssSelector(".product-layout > .product-thumb"));
                            }
                        }
                    }
                    catch (NoSuchElementException ex)
