    ...
    public class smartBuyDishWashers : Hub, IsmartBuyDishWashers
    {
        ...
        public async Task getDishWasher()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://smartbuy-me.com/smartbuystore/ar/%D8%A7%D9%84%D8%A7%D8%AC%D9%87%D8%B2%D8%A9-%D8%A7%D9%84%D9%85%D9%86%D8%B2%D9%84%D9%8A%D8%A9/%D8%A7%D9%84%D8%A7%D8%AC%D9%87%D8%B2%D8%A9-%D8%A7%D9%84%D9%83%D8%A8%D9%8A%D8%B1%D8%A9/%D8%AC%D9%84%D8%A7%D9%8A%D8%A7%D8%AA/c/30104");
                Thread.Sleep(5000);

                Actions actions = new Actions(driver);
                bool flag = true;
                var url = "https://smartbuy-me.com/smartbuystore/ar/%D8%A7%D9%84%D8%A7%D8%AC%D9%87%D8%B2%D8%A9-%D8%A7%D9%84%D9%85%D9%86%D8%B2%D9%84%D9%8A%D8%A9/%D8%A7%D9%84%D8%A7%D8%AC%D9%87%D8%B2%D8%A9-%D8%A7%D9%84%D9%83%D8%A8%D9%8A%D8%B1%D8%A9/%D8%AC%D9%84%D8%A7%D9%8A%D8%A7%D8%AA/c/30104";
                while (true)
                {
                    Thread.Sleep(2000);
                ...
                while (flag)
                {
                    ...
                    {
                        Thread.Sleep(5000);
                        var DishWasher = wait.Until(driver => driver.FindElements(By.CssSelector(".product-item")));
                        int initialDishWashersCount = DishWasher.Count;
                        // Console.WriteLine(driver.FindElements(By.CssSelector(".product-item")).ToList().Count);
                        //loop through all mobiles using productList
                        for (int i = 0; i < initialDishWashersCount; i++)
                        {

                            Console.WriteLine("number of washingMachines " + initialDishWashersCount);
                            Thread.Sleep(2000);
                            ...
                            var NameBeforeClick = wait.Until(driver => DishWasher[i].FindElement(By.CssSelector("a.name.hidden-lg")));
                            ...
                            else
                            {
                                ...
                                driver.ExecuteScript("window.open(arguments[0]);", url + DishWasher[i].FindElement(By.CssSelector(".thumb")).GetAttribute("href"));
                            ...
                            if (i >= initialDishWashersCount - 1)
                            {
