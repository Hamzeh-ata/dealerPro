    ...
    public class OSMouse : Hub, IOSMouse
    {
        ...
        public async Task getMouses()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://os-jo.com/accessories/keyboard-and-mouse/mouse");
                Thread.Sleep(12000);
                ...
                while (true)
                {
                    ...
                    {
                        Thread.Sleep(5000);
                        var mouse = driver.FindElements(By.CssSelector("#ProductsSystem_YD9pMDOx .product-thumb"));
                        for (int i = 0; i < mouse.Count(); i++)
                        {
                            ...
                            else
                            {
                                ...
                                if (driver.FindElements(By.CssSelector("#System_hKPAxwfD > .tb_text_wrap > p")).Count>0 && driver.FindElement(By.CssSelector("#System_hKPAxwfD > .tb_text_wrap > p")).Text == "The page you requested cannot be found.")
                                {
                                    ...
                                    mouse = driver.FindElements(By.CssSelector(".product-thumb"));
                                }
                                else
                                {
                                    Thread.Sleep(10000);
                                    ...
                                    liTexts.Clear();
                                    wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(By.CssSelector(".product-thumb")));
                                    mouse = driver.FindElements(By.CssSelector("#ProductsSystem_YD9pMDOx .product-thumb"));
