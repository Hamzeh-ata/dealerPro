    ...
    public class OSKeyboards : Hub, IOSKeyboards
    {
        ...
        public async Task GetKeyboards()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://os-jo.com/accessories/keyboard-and-mouse/keyboard");
                Thread.Sleep(12000);
                ...
                while (true)
                {
                    ...
                    {
                        Thread.Sleep(5000);
                        var keyBoard = driver.FindElements(By.CssSelector("#ProductsSystem_YD9pMDOx .product-thumb"));
                        for (int i = 0; i < keyBoard.Count(); i++)
                        {
                            ...
                            else
                            {
                                ...
                                keyBoard = driver.FindElements(By.CssSelector("#ProductsSystem_YD9pMDOx .product-thumb"));
