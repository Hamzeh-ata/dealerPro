    ...
    public class OSMB : Hub, iOSMB
    {
        ...
        public async Task getMB()
        {
            ...
            using (var driver = new ChromeDriver(service, chromeOptions))
            {
                ...
                driver.Navigate().GoToUrl("https://os-jo.com/components/motherboards");
                Thread.Sleep(12000);
                ...
                while (true)
                {
                    ...
                    {
                        Thread.Sleep(5000);
                        var mb = driver.FindElements(By.CssSelector("#ProductsSystem_YD9pMDOx .product-thumb"));
                        for (int i = 0; i < mb.Count(); i++)
                        {
                            ...
                            else
                            {
                                ...
                                mb = driver.FindElements(By.CssSelector("#ProductsSystem_YD9pMDOx .product-thumb"));
